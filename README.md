...
* `interruptModule`: Method used when closing the module FROM THE TERMINAL to terminate all processes generated by the module.
* `closeModule`: Method to close the module. Disconnect all the port here, and free memory.
